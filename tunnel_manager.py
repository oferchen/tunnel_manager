...
class TunnelInterface:
    ...
    def create_tunnel_interface(self, *args, **kwargs):
        raise NotImplementedError

    def cleanup_tunnel_interface(self, *args, **kwargs):
        raise NotImplementedError

    def validate_connectivity(self, *args, **kwargs):
        raise NotImplementedError

    def collect_tunnel_data(self, *args, **kwargs):
        raise NotImplementedError
...
class TunnelFactory:
    @staticmethod
    def create_tunnel(tunnel_type, **kwargs):
...
class OutputFormatterFactory:
    formatters = {
        OutputFormatType.JSON: JsonFormatter(),
        OutputFormatType.YAML: YamlFormatter(),
        OutputFormatType.XML: XmlFormatter(),
        OutputFormatType.CSV: CsvFormatter(),
        OutputFormatType.SCRIPT: ScriptFormatter(),
        OutputFormatType.TABLE: TableFormatter()
    }
...
class TunnelManager:
    def __init__(self, tunnel: TunnelInterface):
        self.tunnel = tunnel

    def create(self, vni, src_host, dst_host, bridge_name, src_port=None, dst_port=None, dev=None):
        self.tunnel.create_tunnel_interface(vni, src_host, dst_host, bridge_name, src_port, dst_port, dev)

    def cleanup(self, vni, bridge_name):
        self.tunnel.cleanup_tunnel_interface(vni, bridge_name)

    def validate(self, src_host, dst_host, vni, port=None):
